...
export const StateAnnotation = Annotation.Root({
    ...
    /**
     * Stores the relevant shoes from the database.
     * @type {Array<Shoe & { ShoeGender: ShoeGender[], reviews: ShoeReview[] }>}
     */
    relevantShoes: Annotation<Array<Shoe & { ShoeGender: ShoeGender[], reviews: ShoeReview[] }>>({
        reducer: (existing: Array<Shoe & { ShoeGender: ShoeGender[], reviews: ShoeReview[] }>, newShoes: Array<Shoe & {
            ShoeGender: ShoeGender[],
            reviews: ShoeReview[]
        }>) => {
            return [...existing, ...newShoes];
        },
        default: () => [],
    }),
});
